...
function AlertsPage(){
 ...
 <div className="alerts-workspace-body min-h-0 flex-1">
   ...
   <aside className="alerts-side-stack min-h-0">
     ...
     <section className="panel min-h-0 overflow-y-auto p-3"><div className="text-xs font-semibold">Critérios vigentes</div><div className="mt-2 space-y-2 text-[10px]"><div className="rounded-lg border border-border/45 bg-muted/10 p-2.5"><div className="font-semibold">Limites por shopping</div><p className="mt-1 text-muted-foreground">Balanço, periféricos, desvio da meta e tempo sem atualização vêm da configuração individual de cada unidade.</p></div><div className="rounded-lg border border-border/45 bg-muted/10 p-2.5"><div className="font-semibold">Sem parâmetro, sem alerta</div><p className="mt-1 text-muted-foreground">Condições dependentes de limite configurável só são avaliadas quando o valor existe no PostgreSQL.</p></div></div></section>
   </aside>
 </div>
 </InternalPage>
}
