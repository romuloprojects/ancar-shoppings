...
export function KpiCard({
  ...
  return (
    <article
      className="panel group relative h-[86px] min-w-0 overflow-hidden px-3 py-2 transition-colors duration-200 hover:border-[color-mix(in_oklab,var(--kpi-accent)_32%,var(--border))] 2xl:h-[92px] 2xl:px-3.5"
      style={cardGlowStyle}
    >
      ...
      <div className="relative flex h-full min-w-0 items-center gap-2.5 2xl:gap-3">
        <div
          className="grid h-9 w-9 shrink-0 place-items-center rounded-full border shadow-[inset_0_1px_0_rgb(255_255_255/6%),0_8px_26px_-16px_var(--kpi-accent)] 2xl:h-10 2xl:w-10"
          style={{
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1.5 flex min-w-0 items-baseline gap-1.5">
            <span className="metric-value truncate text-[20px] leading-none text-foreground 2xl:text-[22px]">
              {value}
            </span>
            {unit && (
        ...
        <div className="hidden h-[42px] w-12 shrink-0 self-center opacity-95 lg:block 2xl:w-[72px]">
          <svg
            viewBox="0 0 116 52"
