...
assert(overview.includes('data-ancar-ui-version="5.7.2"'),'V5.7: marcador da home ausente');
assert(rootRoute.includes('ancar-ui=5.7.2')&&rootRoute.includes('content: "5.7.2"'),'V5.7: versão/cache bust ausente');
...
assert(reports.includes('downloadMonthlyPortfolio')&&reports.includes('reportService.download('),'Relatórios: downloads PDF ausentes');
assert(!reports.includes('Exportar CSV')&&!reports.includes('exportCsv'),'Relatórios: exportação CSV deveria estar removida');
assert(!reports.includes('Prévia executiva')&&!reports.includes('Conteúdo dos PDFs'),'Relatórios: prévia/conteúdo PDF deveriam estar removidos');
