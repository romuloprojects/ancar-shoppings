...
root=Path.cwd(); out=root/'validation'/'login-v561'; out.mkdir(parents=True,exist_ok=True)
css=(root/'public'/'login-v561.css').read_text(encoding='utf8')
...
<div class="login-v56-insights"><div class="login-v56-insight"><span>Performance do portfólio</span><strong>Visão multi-site</strong><div class="login-v56-bars"><i></i><i></i><i></i><i></i><i></i></div><small>Indicadores operacionais e econômicos</small></div><div class="login-v56-insight"><span>Sustentabilidade</span><strong>Energia & emissões</strong><div class="login-v56-ring"><i></i></div><small>Eficiência, metas e impacto ambiental</small></div></div>
...
print('VALIDAÇÃO LOGIN V5.6.1: PASS')
